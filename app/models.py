...
class User(UserMixin, db.Model):
    ...
    last_seen: so.Mapped[Optional[datetime]] = so.mapped_column(default=lambda: datetime.now(tz=timezone.utc))
    ...
    def avatar(self, size, default: Literal['mp', 'identicon', 'monsterid', 'wavatar', 'retro', 'robohash', 'blank']='mp'):
...
class Post(db.Model):
    ...
    timestamp: so.Mapped[datetime] = so.mapped_column(index=True, default=lambda: datetime.now(tz=timezone.utc))
